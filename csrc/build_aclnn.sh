...
if [[ "$SOC_VERSION" =~ ^ascend310 ]]; then
    ...
    CUSTOM_OPS="grouped_matmul_swiglu_quant_weight_nz_tensor_list;grouped_matmul_swiglu_quant_v2;moe_distribute_dispatch_v2;lightning_indexer;sparse_flash_attention;matmul_allreduce_add_rmsnorm;moe_init_routing_custom;moe_gating_top_k;"
    SOC_ARG="ascend910b"
